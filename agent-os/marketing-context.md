...
- **Lead with the wedge (painkiller), not the AI vision (expansion):**
  "Switch off your slow, broken-Arabic billing in one afternoon. Fast Arabic invoicing,
...
- **Guarantee (2 parts):** (1) live in under 2 hours or we do setup + migration free and
...
- GTM motion: no card at signup → concierge onboarding = activation → card after go-live.
...
Zee (the orchestrator) plus named specialists: Sami (invoice scanner, in the June 15 MVP),
Mira (migration specialist — the first agent every new customer meets; turns any messy
export from any old system into a live Zerupt tenant), Noor, Arjun, Tariq, Maya. Marketing
...
- Always: 2-hour go-live, free migration, proper Arabic, ZATCA-ready, unlimited staff
  logins, Founding 50 scarcity (with the real seat number), the two-part guarantee.
