...
- User-generated content wrapped with bidi isolation (`lib/bidi.ts`).
...
- Reference skill `shadcn-ui` for component patterns.

### Defensive UX (HIGH — per CLAUDE.md)
...
Reference skills for patterns: `frontend-patterns`, `shadcn-ui`, `coding-standards`.
