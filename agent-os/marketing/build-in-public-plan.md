...
You have 2-3 hours/day, launch is June 15, 2026, and you need content running alongside development without content eating into dev time. This plan keeps content production under 30-45 min/day by making your dev work the raw material for content.
...
| ERP/Retail Insights | 15% | growing up in a family retail-software business, industry problems | "why 80% of mid-market retailers still run on spreadsheets" |
...
| Pillar | % | What | Example |
|--------|---|------|---------|
| Product Vision | 30% | The 2-hour promise, feature previews | "What if your whole shop configured itself in an afternoon?" |
...
```
HOT TAKE:
Here's what the [ERP/retail-tech/SaaS] industry won't tell you: [bold statement]
...
Build an HTML template that renders slides with Puppeteer screenshots. Store at `/content/templates/carousel.html`. Brand: ink `#141310` for dark backgrounds, citron `#979C1A` (or `#C2C84A` on dark) as the accent.
...
### Sections
1. **Hero** -- "Your business, handled. In two hours." + waitlist email input
2. **Problem** -- 3 cards: Legacy bloat (expensive, months, consultant-gated), Manual chaos (spreadsheets, WhatsApp, gut-feel stock), Operate-it-yourself (dumb tools that make you do all the work)
3. **The Zerupt Way** -- 3 steps: Answer questions > AI configures > You're up and running
...
9. **Footer** -- Waitlist CTA repeated, "Launching June 15, 2026"
...
## 9. 12-Day Execution Timeline (template — dates to update for June 15, 2026 launch)
...
- **Content (1h):** Thread: "Growing up in a family retail-software business -- what I learned." Reel: talking-head intro.
...
2. **Shipping consistently beats perfect-then-nothing.** A good-enough tweet posted daily beats a perfect tweet posted weekly. But craft and accuracy are still sacred — never publish something wrong or sloppy about the product.
